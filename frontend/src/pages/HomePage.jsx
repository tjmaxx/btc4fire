...
function Section({ children, tint = false }) {
  return (
    <section className={`py-20 ${tint ? 'bg-black/5 dark:bg-black/20' : ''}`}>
...
function Divider() {
  return <div className="h-px bg-gradient-to-r from-transparent via-gray-300/60 dark:via-white/10 to-transparent mx-8" />;
}
...
const GLOSSARY = [
  ...
  { term: 'ATH',          full: 'All-Time High',                        color: 'text-yellow-500 dark:text-yellow-400', border: 'border-yellow-500/20', bg: 'bg-yellow-900/10',  def: 'The highest price Bitcoin has ever traded at. How far below ATH we are right now is one of the most watched indicators — bigger discounts historically offer better entry points.' },
...
const FEATURES = [
  ...
  { icon: Layers,        color: 'text-yellow-500', title: 'Resource Library',  desc: 'Curated books, tools, and courses — from Bitcoin basics to cold storage.', link: '/resources' },
...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-blue-50 via-gray-50 to-orange-50 dark:from-blue-900 dark:via-slate-900 dark:to-orange-900">

        {/* ── 1. HERO ── */}
        <section className="min-h-[88vh] flex flex-col justify-center">
          <div className="max-w-7xl mx-auto px-4 text-center py-20">
            <div className="inline-flex items-center gap-2 bg-orange-500/20 border border-orange-500/30 rounded-full px-4 py-1.5 text-orange-600 dark:text-orange-300 text-sm font-medium mb-6">
            ...
            <p className="text-xl text-gray-600 dark:text-white/70 mb-4 max-w-2xl mx-auto">
              Bitcoin is the most powerful tool for achieving Financial Independence. Buy it. Hold it. Let scarcity do the work.
            </p>
            <p className="text-gray-400 dark:text-white/40 text-sm mb-10 max-w-xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link to="/blog"  className="inline-block px-8 py-3 bg-gray-900/10 dark:bg-white/10 hover:bg-gray-900/20 dark:hover:bg-white/20 text-gray-900 dark:text-white font-semibold rounded-lg transition-colors">Read the Blog</Link>
              <Link to="/forum" className="inline-block px-8 py-3 bg-gray-900/10 dark:bg-white/10 hover:bg-gray-900/20 dark:hover:bg-white/20 text-gray-900 dark:text-white font-semibold rounded-lg transition-colors">Join the Forum</Link>
            </div>
            {/* Scroll hint */}
            <div className="mt-16 flex flex-col items-center gap-1 text-gray-400 dark:text-white/20 text-xs">
        ...
        <Section>
          <ScrollSection>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">The Bitcoin FIRE Principles</h2>
            <p className="text-gray-500 dark:text-white/50 text-sm mb-6">Why Bitcoin is the optimal savings vehicle for Financial Independence.</p>
          </ScrollSection>
              ...
              return (
                <ScrollSection key={title} delay={i * 80}>
                  <div className={`rounded-xl p-5 border h-full ${bg}`}>
                    ...
                    <p className="text-gray-600 dark:text-white/60 text-xs leading-relaxed">{desc}</p>
                  </div>
                </ScrollSection>
              );
            })}
        ...
        <Section tint>
          <ScrollSection>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Today's Market Signal</h2>
            <p className="text-gray-500 dark:text-white/50 text-sm mb-6">AI-generated daily insight based on live price, ATH distance, and 52-week range — paired with a long-term BTC vs S&amp;P 500 comparison.</p>
          </ScrollSection>
          <ScrollSection>
            <MarketInsight />
          </ScrollSection>
        ...
        <Section>
          <ScrollSection>
            <div className="bg-gradient-to-r from-orange-500/10 to-gray-100 dark:to-slate-900/40 border border-orange-500/30 rounded-2xl p-8">
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-gray-900 dark:text-white">Strategy Inc</h2>
                      <p className="text-orange-500 dark:text-orange-300 text-sm">Formerly MicroStrategy · The Bitcoin Treasury Company</p>
                    </div>
                  </div>
                  <p className="text-gray-600 dark:text-white/70 text-sm leading-relaxed mb-4">
                    ...
                    Their thesis: <span className="text-orange-500 dark:text-orange-300 font-medium">Bitcoin is the only rational savings asset in a world of infinite money printing.</span>
                  </p>
                  <p className="text-gray-500 dark:text-white/60 text-sm leading-relaxed mb-5">
                ...
                <div className="grid grid-cols-2 gap-3 lg:w-72 w-full flex-shrink-0">
                  {STRATEGY_STATS.map(({ label, value, sub }) => (
                    <div key={label} className="bg-white/70 dark:bg-black/30 rounded-xl p-4 border border-gray-200 dark:border-white/10">
                      <p className="text-gray-400 dark:text-white/40 text-xs mb-1">{label}</p>
                      <p className="text-gray-900 dark:text-white font-bold text-lg leading-tight">{value}</p>
                      <p className="text-gray-400 dark:text-white/40 text-xs mt-0.5">{sub}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            {SAYLOR_QUOTES.map(({ quote, context }, i) => (
              <ScrollSection key={quote} delay={i * 100}>
                <div className="bg-white/60 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-5 h-full">
                  <p className="text-gray-700 dark:text-white/80 text-sm italic leading-relaxed mb-3">"{quote}"</p>
        ...
        <Section tint>
          <ScrollSection>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Key Terms</h2>
            <p className="text-gray-500 dark:text-white/50 text-sm mb-6">New to Bitcoin and FIRE? Here's the language you'll see on this site.</p>
          </ScrollSection>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <ScrollSection key={term} delay={i * 60}>
                <div className={`rounded-xl p-5 border h-full ${border} ${bg}`}>
                  <div className="flex items-baseline gap-2 mb-1">
                    ...
                    <span className="text-gray-400 dark:text-white/40 text-xs">{full}</span>
                  </div>
                  <p className="text-gray-600 dark:text-white/60 text-xs leading-relaxed">{def}</p>
                </div>
              </ScrollSection>
            ))}
          </div>
        ...
        <Section tint>
          <ScrollSection>
            <div className="flex items-start justify-between gap-4 mb-2">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">"But I heard Bitcoin…"</h2>
              <span className="text-xs text-gray-400 dark:text-white/30 mt-1.5 flex-shrink-0">Click to expand</span>
            </div>
            <p className="text-gray-500 dark:text-white/50 text-sm mb-6">The 10 most common objections — and the evidence-backed answers that put them to rest.</p>
            <MythAccordion />
          </ScrollSection>
        </Section>
        ...
        <Section>
          <ScrollSection>
            ...
            <p className="text-gray-500 dark:text-white/50 text-sm mb-6">Tools, community, and knowledge to execute your Bitcoin FIRE strategy.</p>
          </ScrollSection>
            ...
            {FEATURES.map(({ icon, color, title, desc, link }, i) => {
              ...
              return (
                <ScrollSection key={title} delay={i * 70}>
                  <Link to={link} className="bg-gray-900/5 dark:bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-gray-900/10 dark:hover:bg-white/20 transition-all group block h-full">
                    <FeatureIcon className={`w-10 h-10 ${color} mb-3`} />
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-orange-400 transition-colors">{title}</h3>
        ...
        <Section tint>
          <ScrollSection>
            ...
            <p className="text-gray-500 dark:text-white/50 text-sm mb-6">Essential sources for Bitcoin news, data, and community.</p>
          </ScrollSection>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {BTC_NEWS_LINKS.map(({ label, url, desc, internal }, i) => (
              <ScrollSection key={label} delay={i * 60}>
                {internal ? (
                  <Link to={url} className="bg-white/60 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-orange-500/40 rounded-xl p-5 transition-all group flex flex-col gap-2 h-full">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-900 dark:text-white font-semibold text-sm group-hover:text-orange-400 transition-colors">{label}</span>
                      <ArrowRight className="w-4 h-4 text-gray-300 dark:text-white/30 group-hover:text-orange-400 transition-colors" />
                    </div>
                    <p className="text-gray-500 dark:text-white/50 text-xs leading-relaxed">{desc}</p>
                  </Link>
                ) : (
                  <a href={url} target="_blank" rel="noopener noreferrer"
                    className="bg-white/60 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-orange-500/40 rounded-xl p-5 transition-all group flex flex-col gap-2 h-full">
                    <div className="flex items-center justify-between">
                      <span className="text-gray-900 dark:text-white font-semibold text-sm group-hover:text-orange-400 transition-colors">{label}</span>
                      <ExternalLink className="w-4 h-4 text-gray-300 dark:text-white/30 group-hover:text-orange-400 transition-colors" />
                    </div>
                    <p className="text-gray-500 dark:text-white/50 text-xs leading-relaxed">{desc}</p>
                  </a>
                )}
        ...
        {!isAuthenticated && (
          <>
            ...
            <Section>
              <ScrollSection>
                <div className="bg-gradient-to-r from-orange-600/20 dark:from-orange-600/30 to-blue-600/20 dark:to-blue-600/30 border border-orange-500/30 rounded-2xl p-10 text-center">
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">Ready to Start Stacking?</h2>
                  <p className="text-gray-500 dark:text-white/60 mb-6 max-w-lg mx-auto text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 pb-10">
          <div className="bg-gray-100 dark:bg-slate-900/80 border border-gray-200 dark:border-slate-700 rounded-xl px-6 py-5">
            <h3 className="text-gray-400 dark:text-white/60 text-xs font-semibold uppercase tracking-wider mb-2">Disclaimer</h3>
        ...
        {/* ── FOOTER ── */}
        <footer className="border-t border-gray-200 dark:border-white/10 bg-gray-100/50 dark:bg-black/50">
          <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col sm:flex-row justify-between items-center gap-3 text-gray-400 dark:text-white/40 text-sm">
            <p>© 2025 BTC4Fire — Not financial advice. Always DYOR.</p>
            <div className="flex gap-6">
              <Link to="/blog"      className="hover:text-gray-600 dark:hover:text-white/70 transition-colors">Blog</Link>
              <Link to="/forum"     className="hover:text-gray-600 dark:hover:text-white/70 transition-colors">Forum</Link>
              <Link to="/resources" className="hover:text-gray-600 dark:hover:text-white/70 transition-colors">Resources</Link>
              <a href="https://www.strategy.com/btc" target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 dark:hover:text-white/70 transition-colors">Strategy Inc</a>
            </div>
          </div>
        </footer>
